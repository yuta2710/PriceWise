        ...
        <div className='flex-1 flex flex-col'>
          ...
          <div className='product-info'>
            <div className='flex flex-col gap-2'>
              ...
              <p className='text-[21px] text-black font-bold'>{product.currency} {formatNumber(product.originalPrice)}</p>
            </div>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <p className='text-sm text-black opacity-50'>
                <span className='text-primary-screen font-semibold'>93% </span> of buyers have recommended this
              </p>
            </div>
          </div>
